...
import Todolist from "../../Component/Assets/todolist.png"
        ...
        <div className="flex flex-wrap justify-center">
          ...
          <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 h-fit my-4 mx-2 shadow-purple-500 shadow-lg rounded-xl">
            <ProjectCards
              ...
              description={
                <div className="text-sm md:text-base text-white text-center lg:text-lg">
                   I developed this project for my Client., integrating backend image and video content seamlessly with the frontend. The design was crafted using FIGMA.
                  <div className="flex justify-center mt-4">
          ...
          <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 h-fit my-4 mx-2 shadow-purple-500 shadow-lg rounded-xl">
            <ProjectCards
              ...
              description={
                <div className="text-sm md:text-base text-white text-center lg:text-lg">
                  I developed this project for Client. In which in drag and place the text. For more details click on explore.
                  <div className="flex justify-center mt-4">
                    <a href="https://github.com/Naitikraj1998" target="_blank" rel="noopener noreferrer">
                      <button className="ios-button bg-gray-800 text-white py-2 px-4 rounded-lg mr-2 hover:bg-gray-700 transition">
                        GitHub
